...
| APUS_BLUESKY_HASHTAGS           |              | A list of comma separated hashtags for BlueSky posts (empty = disabled).     |
...
| APUS_MASTODON_HASHTAGS          |              | A list of comma separated hashtags for Mastodon posts (empty = disabled).    |
